 ...
 */
final class Version20230816152903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoice ADD id_details INT DEFAULT NULL, ADD id_manufacturer INT DEFAULT NULL, DROP id_details_id, DROP id_manufacturer_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE invoice ADD id_details_id INT DEFAULT NULL, ADD id_manufacturer_id INT DEFAULT NULL, DROP id_details, DROP id_manufacturer');
