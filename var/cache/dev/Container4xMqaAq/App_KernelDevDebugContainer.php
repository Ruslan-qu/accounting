...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\CounterpartyController' => 'getCounterpartyControllerService',
            'App\\Controller\\IncomingDocumentsController' => 'getIncomingDocumentsControllerService',
            'App\\Controller\\KuDirController' => 'getKuDirControllerService',
            'App\\Controller\\MainPageController' => 'getMainPageControllerService',
            'App\\Controller\\PartNoController' => 'getPartNoControllerService',
            'App\\Controller\\PriceController' => 'getPriceControllerService',
            'App\\Controller\\RefundController' => 'getRefundControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('aqN3InANu1', 0, ($container->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\RepositoryCounterparty\\CounterpartyRepository' => ['privates', 'App\\Repository\\RepositoryCounterparty\\CounterpartyRepository', 'getCounterpartyRepositoryService', true],
            'App\\Repository\\RepositoryIncomingDocuments\\InvoiceRepository' => ['privates', 'App\\Repository\\RepositoryIncomingDocuments\\InvoiceRepository', 'getInvoiceRepositoryService', true],
            'App\\Repository\\RepositoryIncomingDocuments\\PaymentMethodRepository' => ['privates', 'App\\Repository\\RepositoryIncomingDocuments\\PaymentMethodRepository', 'getPaymentMethodRepositoryService', true],
            'App\\Repository\\RepositoryKuDir\\KuDirRepository' => ['privates', 'App\\Repository\\RepositoryKuDir\\KuDirRepository', 'getKuDirRepositoryService', true],
            'App\\Repository\\RepositoryPartNo\\AvailabilityRepository' => ['privates', 'App\\Repository\\RepositoryPartNo\\AvailabilityRepository', 'getAvailabilityRepositoryService', true],
            'App\\Repository\\RepositoryPartNo\\AxlesRepository' => ['privates', 'App\\Repository\\RepositoryPartNo\\AxlesRepository', 'getAxlesRepositoryService', true],
            'App\\Repository\\RepositoryPartNo\\BodiesRepository' => ['privates', 'App\\Repository\\RepositoryPartNo\\BodiesRepository', 'getBodiesRepositoryService', true],
            'App\\Repository\\RepositoryPartNo\\CarBrandsRepository' => ['privates', 'App\\Repository\\RepositoryPartNo\\CarBrandsRepository', 'getCarBrandsRepositoryService', true],
            'App\\Repository\\RepositoryPartNo\\DetailsListRepository' => ['privates', 'App\\Repository\\RepositoryPartNo\\DetailsListRepository', 'getDetailsListRepositoryService', true],
            'App\\Repository\\RepositoryPartNo\\IdDetailsManufacturerRepository' => ['privates', 'App\\Repository\\RepositoryPartNo\\IdDetailsManufacturerRepository', 'getIdDetailsManufacturerRepositoryService', true],
            'App\\Repository\\RepositoryPartNo\\OriginalRoomsRepository' => ['privates', 'App\\Repository\\RepositoryPartNo\\OriginalRoomsRepository', 'getOriginalRoomsRepositoryService', true],
            'App\\Repository\\RepositoryPartNo\\SidesRepository' => ['privates', 'App\\Repository\\RepositoryPartNo\\SidesRepository', 'getSidesRepositoryService', true],
            'App\\Repository\\RepositoryPrice\\SoldRepository' => ['privates', 'App\\Repository\\RepositoryPrice\\SoldRepository', 'getSoldRepositoryService', true],
            'App\\Repository\\RepositoryRefund\\RefundActivityRepository' => ['privates', 'App\\Repository\\RepositoryRefund\\RefundActivityRepository', 'getRefundActivityRepositoryService', true],
            'App\\Repository\\RepositoryRefund\\RefundDateRepository' => ['privates', 'App\\Repository\\RepositoryRefund\\RefundDateRepository', 'getRefundDateRepositoryService', true],
        ], [
            'App\\Repository\\RepositoryCounterparty\\CounterpartyRepository' => '?',
            'App\\Repository\\RepositoryIncomingDocuments\\InvoiceRepository' => '?',
            'App\\Repository\\RepositoryIncomingDocuments\\PaymentMethodRepository' => '?',
            'App\\Repository\\RepositoryKuDir\\KuDirRepository' => '?',
            'App\\Repository\\RepositoryPartNo\\AvailabilityRepository' => '?',
            'App\\Repository\\RepositoryPartNo\\AxlesRepository' => '?',
            'App\\Repository\\RepositoryPartNo\\BodiesRepository' => '?',
            'App\\Repository\\RepositoryPartNo\\CarBrandsRepository' => '?',
            'App\\Repository\\RepositoryPartNo\\DetailsListRepository' => '?',
            'App\\Repository\\RepositoryPartNo\\IdDetailsManufacturerRepository' => '?',
            'App\\Repository\\RepositoryPartNo\\OriginalRoomsRepository' => '?',
            'App\\Repository\\RepositoryPartNo\\SidesRepository' => '?',
            'App\\Repository\\RepositoryPrice\\SoldRepository' => '?',
            'App\\Repository\\RepositoryRefund\\RefundActivityRepository' => '?',
            'App\\Repository\\RepositoryRefund\\RefundDateRepository' => '?',
        ])));
